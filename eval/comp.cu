...
// ./comp 256 10 0.125 0 (bs, topk, nprobe/ncentroids, is our sys or faiss)
int main(int argc,char **argv){
    ...
    if (che == 0){
        ...
        printf("[%.3f s] Start Profile\n",
                elapsed() - t0);
        // Train profile
        std::string profile_name = "Profile_" + p1 + "10M_" + std::to_string(ncentroids) + ".txt";
