...
struct SmallGpuIndexConfig {
    inline SmallGpuIndexConfig() : device(0), memorySpace(MemorySpace::Device) {}
...
class SmallGpuIndex : public faiss::Index {
   public:
    SmallGpuIndex(
   ...
   protected:
    ...
    const SmallGpuIndexConfig config_;
